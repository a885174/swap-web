...
<template>
          ...
          <template>
          <el-button @click.stop="userdel" >解除用户关联</el-button></template>
...
<script>
  import {getList, getDetail, add,downloadxls, update, remove,importxls,fileUpload,getenantList,SavueTeant,del} from "@/api/swap_scooter/scooter";
