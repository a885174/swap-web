        ...
        <el-button type="danger"
          ...
          <el-button @click.stop="userdel" >上架</el-button></template>
           ...
           <template slot-scope="scope" slot="menu">
            <el-button type="text" size="small" @click="opentable(scope.row)" > 营业时间分配</el-button>
            &nbsp;&nbsp;
...
<script>
  import {getList, getDetail, add, update,updateAddress, addPhoto,remove,del} from "@/api/swap_repair_shop/repairshop";
    import {getPicture} from "@/api/swap_picture/picture";
  import {mapGetters} from "vuex";
  import website from '@/config/website'

  import {getPage,SaveTime,updateSort,removeTime,updatePicture,SavePicture,getStorePicture,removePicture} from "@/api/swap_repair_business/repairbusiness";
