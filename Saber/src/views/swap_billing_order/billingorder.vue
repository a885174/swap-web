...
<!-- 
    ...
    <el-button type="text"
                   size="small"
                   icon="el-icon-document-copy" v-if="scope.row.orderStatus!='1' "  @click="upload(scope.row)">上传凭证</el-button>
...
&nbsp;&nbsp;&nbsp;
    <el-button type="text"
                     @click.stop="finish(scope.row)">结算
        </el-button>
      </template> 
...
<script>
  import {getList, getDetail, add, update, remove,billList,uploadvoucher,editStatus} from "@/api/swap_billing_order/billingorder";
