...
<el-dialog
  ...
  <avue-form :option="formoption" v-model="form" @submit="handleSubmit"></avue-form>
          ...
          <template>
          <el-button @click.stop="userdel" >解除冻结</el-button></template>
...
<script>
  import {getList, getDetail, add,addPhoto, update,updateAddress, removePicture,remove,del,Savemerchant,delemerch,SaveTime,removeTime,SavePicture,getStorePicture,updatePicture} from "@/api/swap_store/store";
